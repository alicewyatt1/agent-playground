...
// Full names verified by clicking through to mutual connections search results
const connectionData: Record<string, { firstDegree: string; secondDegree: string }> = {
  ...
  'LeGrand Bonnet': { firstDegree: 'N', secondDegree: 'Rich Bowen; Ken Gold' },
  'Pankaj Dhanuka': { firstDegree: 'N', secondDegree: '(No LinkedIn URL provided)' },
  'Nate Spears': { firstDegree: 'N', secondDegree: 'Brandon Delgrosso' },
  'Bill Randag': { firstDegree: 'N', secondDegree: 'Aaron Anderson' },
  'Satish Kumar': { firstDegree: 'N', secondDegree: '' },
  'Matt Storey': { firstDegree: 'N', secondDegree: 'David Shanahan; Jonathan G. Blanco; Danielle Noket; Emily Tan; Aaron Anderson' },
  'Dilip Barot': { firstDegree: 'N', secondDegree: '' },
  'Jim Iyoob': { firstDegree: 'N', secondDegree: 'Ian Harriman; Tzvika Agassi; Omair T; Aaron Anderson' },
  'Kaylene Eckels': { firstDegree: 'N', secondDegree: 'Tzvika Agassi' },
  'Vishal Choudhary': { firstDegree: 'N', secondDegree: '' },
  'Chris Basile': { firstDegree: 'N', secondDegree: 'Chase Watts' },
  ...
  'Kenneth Loggins': { firstDegree: 'N', secondDegree: 'Aaron Anderson' },
  'Greg Alcorn': { firstDegree: 'N', secondDegree: 'Ian Harriman; Aaron Anderson' },
  'David Fisher': { firstDegree: 'N', secondDegree: 'Stephanie Corliss' },
  'Nanette Harrell': { firstDegree: 'N', secondDegree: '' },
  'Emily Slota': { firstDegree: 'N', secondDegree: 'Efi Dahan; Josh Schoonmaker' },
  ...
  'David Kreiss': { firstDegree: 'N', secondDegree: 'Karla M. Cosgalla' },
  'Rodd Furlough': { firstDegree: 'N', secondDegree: '' },
  'Michelle Pittsenbarger': { firstDegree: 'N', secondDegree: '' },
  'Jim Watson': { firstDegree: 'N', secondDegree: 'Amir Kazemi' },
  'Curt Cornum': { firstDegree: 'N', secondDegree: 'Lisa Glover; Dominic Cameron' },
  'Michelle Winnett': { firstDegree: 'N', secondDegree: 'Alex Rosen; Josh DiDomenico' },
  'Justin Nalder': { firstDegree: 'N', secondDegree: '' },
  'Matthew Fisher': { firstDegree: 'N', secondDegree: 'Jordan Cooper' },
  'Kevin Welch': { firstDegree: 'Y', secondDegree: '' },
  'Stephanie Anthony': { firstDegree: 'N', secondDegree: 'Stephanie Foster; Kate Gardiner; Dylani Herath' },
  'Hemal Mewada': { firstDegree: 'N', secondDegree: '' },
  'Thomas Monaghan': { firstDegree: 'N', secondDegree: 'Maxim Wheatley' },
  'Omeed Jafari': { firstDegree: 'N', secondDegree: '' },
  'Petro Bondarevskyi': { firstDegree: 'N', secondDegree: 'Manana Samuseva' },
  'Dominic Leide': { firstDegree: 'N', secondDegree: 'Aaron Anderson' },
  'Vidya Ravichandran': { firstDegree: 'N', secondDegree: 'Gayla Burks; Maria Karaivanova; Jonny Price' },
  'Joseph DeWoody': { firstDegree: 'N', secondDegree: 'Noah Berkson' },
  'Jim Radzicki': { firstDegree: 'N', secondDegree: 'Alex Bouaziz; A.S. Oberoi' },
  'Butch Valenzuela': { firstDegree: 'N', secondDegree: 'Zack Holland; Jeielle Jea Paguntalan; Mark Del Rosario; Simon Sandoval; Karen Batungbacal; Julian Kyle Lizares Valenzuela' },
  'Maria L. Valenzuela': { firstDegree: 'N', secondDegree: 'Julian Kyle Lizares Valenzuela' },
};
